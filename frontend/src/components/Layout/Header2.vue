  ...
  <div class="w-full h-full font-poppins">
    ...
    <div class="navbar flex-col lg:flex-row items-center justify-between gap-2">
      ...
      <div class="w-full flex items-center justify-between lg:hidden">
        ...
        <!-- Logo -->
        <a
          class="btn btn-ghost text-xl text-dark-slate"
      ...
      <div class="hidden lg:flex w-full items-center justify-between">
        ...
        <div class="flex items-center gap-6">
          <!-- Logo -->
          <a
            class="btn btn-ghost text-xl font-poppins text-dark-slate"
            @click="router.push('/homepage')"
            >Pathfinder</a
          >
        </div>
        ...
        <!-- Profile Button lg -->
        <div class="w-10">
          <button class="btn btn-ghost" @click="router.push('/profilepage')">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
