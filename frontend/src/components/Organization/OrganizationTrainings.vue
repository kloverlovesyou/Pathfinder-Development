<template>
  <div class="organization-trainings" :class="{ 'sidebar-expanded': isSidebarOpen }">
...
@media (max-width: 768px) {
  ...
  .organization-trainings.sidebar-expanded .content {
...
.modal-overlay {
  ...
  /* Ensures it's above the rest of the page content, including sidebar */
  z-index: 10000;
...
/* Mobile responsive for training popup */
@media (max-width: 768px) {
  .training-popup-overlay {
    padding: 10px;
    left: 0;
...
.training-details-body {
  flex: 0 0 auto;
  overflow-x: visible; /* Allow content to scroll horizontally */
  overflow-y: visible;
...
/* Mobile: Allow registrants section to scroll horizontally */
@media (max-width: 768px) {
  .registrants-section {
    overflow-x: visible; /* Allow section to scroll horizontally */
    overflow-y: visible; /* No separate vertical scroll - scrolls with modal */
    padding-right: 0;
  }
}
...
/* Mobile: Make registrants table horizontally scrollable */
@media (max-width: 768px) {
  .registrants-table-container.inline {
    overflow-x: auto;
    overflow-y: visible;
  ...
  .registrants-table-container.inline table {
    min-width: 800px; /* Ensure table doesn't shrink below this width */
    width: 100%;
  }

  /* Optional: Add scrollbar styling for better UX */
  .registrants-table-container.inline::-webkit-scrollbar {
    height: 8px;
  }

  .registrants-table-container.inline::-webkit-scrollbar-track {
    background: #f1f1f1;
    border-radius: 4px;
  }

  .registrants-table-container.inline::-webkit-scrollbar-thumb {
    background: #888;
    border-radius: 4px;
  }

  .registrants-table-container.inline::-webkit-scrollbar-thumb:hover {
    background: #555;
  }
}
