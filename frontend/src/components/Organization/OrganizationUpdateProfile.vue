            ...
            <aside class="sidebar" :class="{ collapsed: !isSidebarOpen }" @click.stop>
                ...
                <div class="avatar" @click.stop>
                    ...
                    <div v-else class="avatar-placeholder">
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M20.59 22C20.59 18.13 16.74 15 12 15C7.26 15 3.41 18.13 3.41 22" stroke="white"
                ...
                <transition name="fade">
                    <div v-if="isSidebarOpen" class="profile-section">
                        <h3 class="org-name">
                            {{ organizationName }}
                            <span v-if="organizationStatus !== null" class="org-status-inline"
                                :class="organizationStatusClass">
                                <svg v-if="isOrganizationVerified" class="org-status-icon-inline"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                                    <path d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="2.2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <svg v-else class="org-status-icon-inline" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="action" @click.stop="navigateTo({ name: 'OrgChangePassword' })">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#FFFDFD" stroke-width="2" stroke-linecap="round"
            ...
            <div class="update-profile-container">
                ...
                <form @submit.prevent="updateAccount">
                    ...
                    <div class="logo-upload-section">
                        ...
                        <div class="logo-preview-container">
                            ...
                            <div class="logo-upload-controls">
                                <label for="logo-upload" class="logo-upload-btn" :class="{ disabled: otpRequested }"
                                    :style="{ pointerEvents: otpRequested ? 'none' : 'auto', opacity: otpRequested ? 0.6 : 1 }">
                                ...
                                <input type="file" id="logo-upload"
                                    ...
                                    @change="handleLogoSelect" :disabled="otpRequested" style="display: none;" />
                                <button v-if="logoFile || logoUrl" type="button" @click="removeLogo"
                                    class="logo-remove-btn" :disabled="otpRequested"
                    ...
                    <div v-if="otpRequested" class="input-with-counter">
                        ...
                        <input type="text" v-model="form.otp" placeholder="Enter 6-digit code from email" required
        ...
        <div class="fixed top-5 right-5 space-y-2 z-50">
            <div v-for="toast in toasts" :key="toast.id" :class="[
                ...
                <template v-if="toast.type === 'confirm'">
                    <button @click="toast.onConfirm()" class="px-2 py-1 bg-white text-black rounded">
                        Yes
                    </button>
                    <button @click="toast.onCancel()" class="px-2 py-1 bg-gray-700 text-white rounded">
                        No
                    </button>
                </template>
            </div>
...
// Sidebar state - Load from localStorage, default to true for first visit
const savedSidebarState = localStorage.getItem('orgSidebarOpen');
const isSidebarOpen = ref(savedSidebarState !== null ? savedSidebarState === 'true' : true);
const toggleSidebar = () => {
    isSidebarOpen.value = !isSidebarOpen.value;
...
@media (max-width: 768px) {
    ...
    .content {
        ...
        width: calc(100% - 60px);
        margin-left: 60px;
        /* Space for collapsed sidebar (60px) */
        transition: margin-left 0.3s ease-in-out, width 0.3s ease-in-out;
        box-sizing: border-box;
    }
