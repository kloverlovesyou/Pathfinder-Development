...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We would like to inform you that the training details for <strong>{{ $trainingTitle }}</strong> by <strong>{{ $organizationName }}</strong> have been updated.</p>
            ...
            <div class="training-details">
                ...
                <div class="schedule-item">
                    <h4>Schedule {{ $loop->iteration }}</h4>
                    
                    <div class="detail-row">
                        <span class="detail-label">Start Date & Time:</span>
                        <span class="detail-value">{{ $schedule['start_time'] }}</span>
                    </div>
                    
                    <div class="detail-row">
                        <span class="detail-label">End Date & Time:</span>
                        <span class="detail-value">{{ $schedule['end_time'] }}</span>
                    </div>
                    
                    <div class="detail-row">
                        <span class="detail-label">Mode:</span>
                        <span class="detail-value">{{ $schedule['mode'] }}</span>
                    </div>
                    
                    @if($schedule['mode'] === 'On-Site' && isset($schedule['location']) && $schedule['location'])
                    <div class="detail-row">
                    ...
                    @if($schedule['mode'] === 'Online' && isset($schedule['training_link']) && $schedule['training_link'])
                    <div class="detail-row">
                        <span class="detail-label">Meeting Link:</span>
                        <span class="detail-value">
                            <a href="{{ $schedule['training_link'] }}" class="link" target="_blank">{{ $schedule['training_link'] }}</a>
                        </span>
                    </div>
                    @endif
                </div>
